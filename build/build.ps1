...
$projectPath = "..\src\OpenSsl.Crypto.Utility\OpenSsl.Crypto.Utility.csproj"
...
Write-Host "Building OpenSsl.Crypto.Utility projects (OpenSsl.Crypto.Utility.csproj traversal)..." -ForegroundColor "Magenta"
