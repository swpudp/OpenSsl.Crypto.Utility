...
namespace OpenSsl.Crypto.Utility
{
    internal static class DigestUtils
    {
        ...
        /// <returns></returns>
        public static byte[] ComputeHashBytes(IDigest digest, string data, Encoding encoding)
        {
        ...
        /// <param name="encoding"></param>
        /// <returns></returns>
        public static byte[] ComputeHashBytes(IMac hmac, string key, string data, Encoding encoding)
        {
