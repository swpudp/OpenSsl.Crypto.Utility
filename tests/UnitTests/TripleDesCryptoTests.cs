...
namespace UnitTests
{
    ...
    public class TripleDesCryptoTests
    {
        ...
        public void EncryptToBase64WithCBCPKCS5Test()
        {
            ...
            string cipher = CryptoUtils.TripleDesEncryptToBase64(content, key, CipherMode.CBC, CipherPadding.PKCS7, iv);
        ...
        public void DecryptFromBase64WithCBCPKCS5Test()
        {
            ...
            string actual = CryptoUtils.TripleDesDecryptFromBase64(cipher, key, CipherMode.CBC, CipherPadding.PKCS5, iv);
        ...
        public void EncryptToBase64WithCBCPKCS5SameKeyTest()
        {
            ...
            string iv = secretHex.Substring(24);
            string content = "123456";
            string cipher = CryptoUtils.TripleDesEncryptToBase64(content, key, CipherMode.CBC, CipherPadding.PKCS5, iv);
            string plainText = CryptoUtils.TripleDesDecryptFromBase64(cipher, key, CipherMode.CBC, CipherPadding.PKCS5, iv);
        ...
        public void EncryptToBase64WithoutIVTest()
        {
            ...
            string key = secretHex.Substring(0, 24);
            string content = "123456";
            string cipher = CryptoUtils.TripleDesEncryptToBase64(content, key, CipherMode.CBC, CipherPadding.PKCS5);
            string plainText = CryptoUtils.TripleDesDecryptFromBase64(cipher, key, CipherMode.CBC, CipherPadding.PKCS5);
            Assert.AreEqual(content, plainText);
        }
    }
}
